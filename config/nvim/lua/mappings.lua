...
map("n", "<Leader>ff", function() vim.lsp.buf.formatting_seq_sync({ timeout_ms = 10000 }) end)
...
map("n", "<C-p>", function() require 'telescope.builtin'.find_files({ hidden = true, no_ignore = false }) end,
